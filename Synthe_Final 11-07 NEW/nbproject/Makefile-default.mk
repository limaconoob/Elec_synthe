...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/Synthe_Final_11-07.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=configBits.c Init_pins.c Display.c Main.c Encodeur.c Preset.c AudioBuffer.c DAC.c MIDI.c menus.c Boutons.c Create_tab_freq.c tab_sinus.c TabCreate.c Filter_control.c Enveloppe.c flash.c tab_noise.c Arpeggios.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/configBits.o ${OBJECTDIR}/Init_pins.o ${OBJECTDIR}/Display.o ${OBJECTDIR}/Main.o ${OBJECTDIR}/Encodeur.o ${OBJECTDIR}/Preset.o ${OBJECTDIR}/AudioBuffer.o ${OBJECTDIR}/DAC.o ${OBJECTDIR}/MIDI.o ${OBJECTDIR}/menus.o ${OBJECTDIR}/Boutons.o ${OBJECTDIR}/Create_tab_freq.o ${OBJECTDIR}/tab_sinus.o ${OBJECTDIR}/TabCreate.o ${OBJECTDIR}/Filter_control.o ${OBJECTDIR}/Enveloppe.o ${OBJECTDIR}/flash.o ${OBJECTDIR}/tab_noise.o ${OBJECTDIR}/Arpeggios.o
POSSIBLE_DEPFILES=${OBJECTDIR}/configBits.o.d ${OBJECTDIR}/Init_pins.o.d ${OBJECTDIR}/Display.o.d ${OBJECTDIR}/Main.o.d ${OBJECTDIR}/Encodeur.o.d ${OBJECTDIR}/Preset.o.d ${OBJECTDIR}/AudioBuffer.o.d ${OBJECTDIR}/DAC.o.d ${OBJECTDIR}/MIDI.o.d ${OBJECTDIR}/menus.o.d ${OBJECTDIR}/Boutons.o.d ${OBJECTDIR}/Create_tab_freq.o.d ${OBJECTDIR}/tab_sinus.o.d ${OBJECTDIR}/TabCreate.o.d ${OBJECTDIR}/Filter_control.o.d ${OBJECTDIR}/Enveloppe.o.d ${OBJECTDIR}/flash.o.d ${OBJECTDIR}/tab_noise.o.d ${OBJECTDIR}/Arpeggios.o.d
...
# Source Files
SOURCEFILES=configBits.c Init_pins.c Display.c Main.c Encodeur.c Preset.c AudioBuffer.c DAC.c MIDI.c menus.c Boutons.c Create_tab_freq.c tab_sinus.c TabCreate.c Filter_control.c Enveloppe.c flash.c tab_noise.c Arpeggios.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/Synthe_Final_11-07.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/tab_noise.o: tab_noise.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/tab_noise.o.d 
	@${RM} ${OBJECTDIR}/tab_noise.o 
	@${FIXDEPS} "${OBJECTDIR}/tab_noise.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_ICD3=1 -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/tab_noise.o.d" -o ${OBJECTDIR}/tab_noise.o tab_noise.c   
	
${OBJECTDIR}/Arpeggios.o: Arpeggios.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/Arpeggios.o.d 
	@${RM} ${OBJECTDIR}/Arpeggios.o 
	@${FIXDEPS} "${OBJECTDIR}/Arpeggios.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_ICD3=1 -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/Arpeggios.o.d" -o ${OBJECTDIR}/Arpeggios.o Arpeggios.c   
...
${OBJECTDIR}/tab_noise.o: tab_noise.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/tab_noise.o.d 
	@${RM} ${OBJECTDIR}/tab_noise.o 
	@${FIXDEPS} "${OBJECTDIR}/tab_noise.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/tab_noise.o.d" -o ${OBJECTDIR}/tab_noise.o tab_noise.c   
	
${OBJECTDIR}/Arpeggios.o: Arpeggios.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/Arpeggios.o.d 
	@${RM} ${OBJECTDIR}/Arpeggios.o 
	@${FIXDEPS} "${OBJECTDIR}/Arpeggios.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/Arpeggios.o.d" -o ${OBJECTDIR}/Arpeggios.o Arpeggios.c   
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/Synthe_Final_11-07.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -mdebugger -D__MPLAB_DEBUGGER_ICD3=1 -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/Synthe_Final_11-07.${IMAGE_TYPE}.${OUTPUT_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}           -mreserve=data@0x0:0x1FC -mreserve=boot@0x1FC02000:0x1FC02FEF -mreserve=boot@0x1FC02000:0x1FC024FF  -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_ICD3=1,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map"
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/Synthe_Final_11-07.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/Synthe_Final_11-07.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}          -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map"
	${MP_CC_DIR}\\xc32-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/Synthe_Final_11-07.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} 
endif
