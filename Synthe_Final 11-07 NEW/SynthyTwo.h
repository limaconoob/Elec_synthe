...
# define FLASH (void *)0x9D00DC04
extern u32 flash_adress;
...
extern char    name_buf[13];
void        printName(char *str);

void  init_factoryPreset(void);
extern u8      cursor_pos;

extern u8  curBank;
extern u8  curPreset;
extern u8  presets[1][100][30];
...
extern    menus menu_tab[10][4];
extern    u8*   params_tab[10][4];
