...
{
    return (phase1 == 1 ? seuil_min1 - cur_amplitude1 - (2 * (phi1 * cursor1)) : seuil_max1 + cur_amplitude1 + (2 * (phi1 * cursor1)));
}

u16            onde_sawtooth(void)
{
    return (phase1 == 1 ? seuil_min1 - cur_amplitude1 - (phi1 * cursor1) : 0xFFFF - (phi1 * cursor1));
}

u16            onde_sawtooth_reverse(void)
{
    return (phase1 == 1 ? phi1 * cursor1 : seuil_max1 + cur_amplitude1 + (phi1 * cursor1));
}

u16            onde_carre()
{
    return (phase1 == 1 ? seuil_min1 - cur_amplitude1 : seuil_max1 + cur_amplitude1);
}
...
{
    return (phase2 == 1 ? seuil_min2 - cur_amplitude2 - (2 * (phi2 * cursor2)) : seuil_max2 + cur_amplitude2 + (2 * (phi2 * cursor1)));
}

u16            onde_sawtooth2(void)
{
    return (phase2 == 1 ? seuil_min2 - cur_amplitude2 - (phi2 * cursor2) : 0xFFFF - (phi2 * cursor2));
}

u16            onde_sawtooth_reverse2(void)
{
    return (phase2 == 1 ? phi2 * cursor2 : seuil_max2 + cur_amplitude2 + (phi2 * cursor2));
}

u16            onde_carre2()
{
    return (phase2 == 1 ? seuil_min2 - cur_amplitude2 : seuil_max2 + cur_amplitude2);
}